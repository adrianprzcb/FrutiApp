...
public class Nivel6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_nombre = (TextView)findViewById(R.id.tv_jugador);
        tv_score = (TextView)findViewById(R.id.tv_score);
        iv_vidas = (ImageView)findViewById(R.id.imageViewVidas);
        iv_Auno = (ImageView)findViewById(R.id.numUno);
        iv_Ados = (ImageView)findViewById(R.id.numDos);
        et_respuesta = (EditText)findViewById(R.id.resultado);
        iv_signo =findViewById(R.id.signo);
    ...
    public void NumAleatorio(){
        if(score <= 1000000){
            ...
            }else if(numAleatorio_uno>=4 && numAleatorio_uno <=6){
                resultado = numAleatorio_uno - numAleatorio_dos;
            ...
            Toast.makeText(this, "JUEGO TERMINADO, Eres un genio", Toast.LENGTH_LONG).show();
            startActivity(intent);
            finish();
            mp.stop();
            mp.release();
    ...
    public void BaseDeDatos(){
        ...
        if(consulta.moveToFirst()){
            ...
            if(score > bestScore){
                ...
                modificacion.put("name", nombre_jugador);
            ...
            insertar.put("name", nombre_jugador);
